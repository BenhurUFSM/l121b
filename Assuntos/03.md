## Números binários, tipos de dados básicos em C, variáveis, scanf
...
1. Breve aparecerá aqui a descrição do programa a fazer como E3.
Coloque esse programa em um arquivo chamado "e3-fulano.c", anexe-o a um mail com assunto "l1-e3-fulano", envie o mail para "benhur+l121b@inf.ufsm.br". Substitua "fulano" por seu login no domínio inf ou seu número de matrícula.
