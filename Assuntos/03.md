...
Coloque esse programa em um arquivo chamado `e3-fulano.c`, anexe-o a um mail com assunto `l1-e3-fulano`, envie o mail para o endereço oficial. Substitua "fulano" por seu login no domínio inf ou seu número de matrícula.
