...
9. Faça um programa que lê um número do usuário e imprime esse número de linhas. A primeira linha deve ter 1 asterisco, a segunda deve ter 2, a terceira 3 etc. O programa deve usar a função anterior para imprimir os tantos asteriscos de uma linha.
   ...
   *****
   ```
10. Faça um programa que imprime o contrário do anterior:
   ```
   *****
   ****
   ***
   ...
   *
   ```
11. De novo, mas se o usuário digitar 5, deve imprimir 4 espaços e um asterisco na primeira linha, 3 espaços e dois asteriscos na segunda etc nenhum espaço e 5 asteriscos na quinta:
   ```
       *
      **
     ***
    ...
    *******
     *****
      ***
       *
   ```
   Esse é o **E5**. O programa deve ler um número e imprimir o losango correspondente.
